package com.zzmstring.viewset.View;
...
public class DragGrid extends GridView {
	...
	/** 每个ITEM之间的水平间距 */
	private int mHorizontalSpacing = 25;
	/** 每个ITEM之间的竖直间距 */
	private int mVerticalSpacing = 25;
	/* 移动时候最后个动画的ID */
	...
	public void init(Context context){
		...
		//将布局文件中设置的间距dip转为px
		mHorizontalSpacing = ParamsUtil.dip2px(context, mHorizontalSpacing);
	}
